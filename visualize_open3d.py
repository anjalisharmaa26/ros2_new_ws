...
# ---------- USER CONFIG ----------
pcd_file = "demo/data/kitti/000008.bin"       # LiDAR .bin file
pred_file = "outputs/preds/000008.json"       # model prediction JSON
output_image = "outputs/open3d_render.png"   # path to save rendered image
# ---------------------------------
...
vis.create_window(visible=False)  # <-- important: window will not open
